...
extern void DriverVoltageAlarmLevelSet(float nValue); // Rogerio adicionou
extern void DriverVoltageTripLevelSet(float nValue);  // Rogerio adicionou

extern unsigned char Driver1CurrentAlarmStatusRead(void);
extern unsigned char Driver1CurrentTripStatusRead(void);

extern void Driver1CurrentAlarmLevelSet(float nValue); // Rogerio adicionou
extern void Driver1CurrentTripLevelSet(float nValue);  // Rogerio adicionou

extern unsigned char Driver2CurrentAlarmStatusRead(void);
extern unsigned char Driver2CurrentTripStatusRead(void);

extern void Driver2CurrentAlarmLevelSet(float nValue); // Rogerio adicionou
extern void Driver2CurrentTripLevelSet(float nValue);  // Rogerio adicionou
