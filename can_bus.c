...
void InitConsole(void)
{
    ...
    //
    // Configure the pin muxing for UART2 functions on port A6 and A7.
    ...
    //
    UARTStdioConfig(2, 115200, 120000000);
}
...
void InitCan(uint32_t ui32SysClock)
{
    ...
    CANIntRegister(CAN0_BASE, &can_isr); // using dynamic vectors
...
void send_data_message(uint8_t var)
{
    ...
    case FAP:
        ...
        case 0:
            ...
            message_data_iib[0] = g_controller_iib.iib_signals[0].u8[0];
            message_data_iib[1] = g_controller_iib.iib_signals[0].u8[1];
            message_data_iib[2] = g_controller_iib.iib_signals[0].u8[2];
            message_data_iib[3] = g_controller_iib.iib_signals[0].u8[3];
            message_data_iib[4] = g_controller_iib.iib_signals[1].u8[0];
            message_data_iib[5] = g_controller_iib.iib_signals[1].u8[1];
        ...
        case 1:
            ...
            message_data_iib[0] = g_controller_iib.iib_signals[2].u8[0];
            message_data_iib[1] = g_controller_iib.iib_signals[2].u8[1];
            message_data_iib[2] = g_controller_iib.iib_signals[2].u8[2];
            message_data_iib[3] = g_controller_iib.iib_signals[2].u8[3];
            message_data_iib[4] = g_controller_iib.iib_signals[3].u8[0];
        ...
        case 2:
            ...
            message_data_iib[0] = g_controller_iib.iib_signals[6].u8[0];
            message_data_iib[1] = g_controller_iib.iib_signals[6].u8[1];
            message_data_iib[2] = g_controller_iib.iib_signals[6].u8[2];
            message_data_iib[3] = g_controller_iib.iib_signals[6].u8[3];
            message_data_iib[4] = g_controller_iib.iib_signals[11].u8[0];
            message_data_iib[5] = g_controller_iib.iib_signals[11].u8[1];
        ...
        case 3:
            ...
            message_data_iib[0] = g_controller_iib.iib_signals[7].u8[0];
            message_data_iib[1] = g_controller_iib.iib_signals[7].u8[1];
            message_data_iib[2] = g_controller_iib.iib_signals[7].u8[2];
            message_data_iib[3] = g_controller_iib.iib_signals[7].u8[3];
            message_data_iib[4] = g_controller_iib.iib_signals[8].u8[0];
